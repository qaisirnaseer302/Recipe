...
const wellcomeController=(req,res)=>{
    res.sendFile(`${userViews}/wellcomePage.html`)
}
const editProfileController=(req,res)=>{
    res.sendFile(`${userViews}/editprofile.html`)
}
module.exports={homeController,recipeController,userProofileController,signUpController,logInController,wellcomeController,editProfileController};